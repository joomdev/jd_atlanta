...
ie.cssHooks[t]=k(ne.pixelPosition,function(e,n){return n?(n=tt(e,t),rt.test(n)?ie(e).position()[t]+"px":n):void 0})}),ie.each({Height:"height",Width:"width"},function(e,t){ie.each({padding:"inner"+e,content:t,"":"outer"+e},function(n,r){ie.fn[r]=function(r,i){var o=arguments.length&&(n||"boolean"!=typeof r),a=n||(r===!0||i===!0?"margin":"border");return je(this,function(t,n,r){var i;return ie.isWindow(t)?t.document.documentElement["client"+e]:9===t.nodeType?(i=t.documentElement,Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):void 0===r?ie.css(t,n,a):ie.style(t,n,r,a)},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var on=e.jQuery,an=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=an),t&&e.jQuery===ie&&(e.jQuery=on),ie},typeof t===Ne&&(e.jQuery=e.$=ie),ie}),jQuery.noConflict())}(),N2Deferred.prototype._doCallbacks=function(){if(0!==this.state)for(;this.callbacks.length>0;)this.callbacks.shift().call(window)},N2Deferred.prototype.resolve=function(){this.state=1,this._doCallbacks()},N2Deferred.prototype.reject=function(){this.state=-1,this._doCallbacks()},N2Deferred.prototype.then=function(e){this.callbacks.push(e),this._doCallbacks()},N2Deferred.n2When=function(e){var t=e.length,n=new N2Deferred;if(0===t)n.resolve();else for(var r=0,i=function(){r++,r===t&&n.resolve()},o=0;t>o;o++)e[o]instanceof N2Deferred?e[o].then(i):i();return n},function(e){"use strict";this.N2Classes={};var t={};this.N2D=function(n,r,i){var o=[];if(n&&t[n]===e&&(t[n]=new N2Deferred),2===arguments.length?(i=arguments[1],r=[]):"string"==typeof r&&(r=[r]),r=r||[],"$"!==n&&r.push("$"),r.length)for(var a=0;a<r.length;a++)t[r[a]]===e&&(t[r[a]]=new N2Deferred),o.push(t[r[a]]);N2Deferred.n2When(o).then(function(){"function"==typeof i?N2Classes[n]=i.apply(N2Classes,[N2Classes.$]):N2Classes[n]=!0,t[n].resolve()})};for(var n=0;n<this.N2_.d.length;n++)this.N2D.apply(this,this.N2_.d[n]);this.N2R=function(n,r){var i=[];if(1===arguments.length?(r=arguments[0],n=[]):"string"==typeof n&&(n=[n]),n=n||[],n.push("$"),n!==e&&n)for(var o=0;o<n.length;o++)t[n[o]]===e&&(t[n[o]]=new N2Deferred),i.push(t[n[o]]);N2Deferred.n2When(i).then(function(){for(var e=[N2Classes.$],t=0;t<n.length-1;t++)e.push(N2Classes[n[t]]);r.apply(N2Classes,e)})};for(var r=0;r<this.N2_.r.length;r++)this.N2R.apply(this,this.N2_.r[r])}.call(window),function(){var e=new Date,t=function(){if(window.nextend&&window.jQuery){var n=window.jQuery;N2D("$",function(){return window.n2=n,n}),n(document).ready(function(){N2D("documentReady")}),"complete"===document.readyState?N2D("windowLoad"):n(window).on("load",function(){N2D("windowLoad")})}else if(setTimeout(t,20),(new Date).getTime()-e.getTime()>1e3){var r=document.createElement("script");r.src="//ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js",document.getElementsByTagName("head")[0].appendChild(r)}};t()}(),N2R("$",function(e){var t={};e.each(["Quad","Cubic","Quart","Quint","Expo"],function(e,n){t[n]=function(t){return Math.pow(t,e+2)}}),e.extend(t,{Sine:function(e){return 1-Math.cos(e*Math.PI/2)},Circ:function(e){return 1-Math.sqrt(1-e*e)},Elastic:function(e){return 0===e||1===e?e:-Math.pow(2,8*(e-1))*Math.sin((80*(e-1)-7.5)*Math.PI/15)},Back:function(e){return e*e*(3*e-2)},Bounce:function(e){for(var t,n=4;e<((t=Math.pow(2,--n))-1)/11;);return 1/Math.pow(4,3-n)-7.5625*Math.pow((3*t-2)/22-e,2)}}),e.each(t,function(t,n){e.easing["easeIn"+t]=n,e.easing["easeOut"+t]=function(e){return 1-n(1-e)},e.easing["easeInOut"+t]=function(e){return.5>e?n(2*e)/2:1-n(-2*e+2)/2}})}),N2D("n2-jquery");