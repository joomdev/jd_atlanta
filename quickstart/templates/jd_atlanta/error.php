...
if ($logo_image = $params->get('error_logo')) {
    ...
    $logo 		= $this->baseurl . '/templates/' . $this->template . '/images/presets/preset1/logo2.png';
    $path 		= JPATH_ROOT . '/templates/' . $this->template . '/images/presets/preset1/logo2.png';
    $ratlogo 	= $this->baseurl . '/templates/' . $this->template . '/images/presets/preset1/logo2@2x.png';
}
