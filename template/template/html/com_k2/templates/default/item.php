...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<span class="itemAuthor">
		<i class="fa fa-user-o" aria-hidden="true"></i> <?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?>
	...
	<!-- Item Hits -->
	<span class="itemHits">
		<i class="fa fa-eye" aria-hidden="true"></i> <?php echo $this->item->hits; ?>
	</span>
	<?php endif; ?>
	</div>
	...
	<div class="itemAuthorBlock">
		...
		<div class="itemAuthorDetails">
			...
			<span class="itemAuthorUrl"><a rel="me" href="<?php echo $this->item->author->profile->url; ?>" target="_blank"><?php echo str_replace('http://','',$this->item->author->profile->url); ?></a></span>
			<?php endif; ?>
